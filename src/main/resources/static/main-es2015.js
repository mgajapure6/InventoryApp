...
module.exports = __webpack_require__(/*! C:\Users\EPS01\Documents\My Received Files\ERP-Saurabh\InventoryAngular\src\main.ts */"zUnb");
...
/* harmony import */ var _guard__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./guard */ "KsZM");
...
EndPoint = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
/* harmony import */ var _endpoints__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./endpoints */ "Mumn");
/* harmony import */ var _shared__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./shared */ "M0ag");
/* harmony import */ var _shared_services_api_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./shared/services/api.service */ "nm5K");
/* harmony import */ var ngx_toggle_switch__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ngx-toggle-switch */ "TnO9");
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
        imports: [
            ...
            ngx_toggle_switch__WEBPACK_IMPORTED_MODULE_12__["UiSwitchModule"],
...
let ApiService = class ApiService {
    constructor(ep, httpClient) {
        this.ep = ep;
        this.httpClient = httpClient;
    }
    getItemById(id) {
        const url = this.ep.itemById + '/' + id;
        return this.httpClient.get(url);
    }
    itemList() {
        const url = this.ep.itemList;
        return this.httpClient.get(url);
    }
    saveItem(item) {
        const url = this.ep.saveItem;
        return this.httpClient.post(url, item);
    }
    updateItem(item) {
        const url = this.ep.updateItem;
        return this.httpClient.put(url, item);
    }
    deleteItem(id) {
        const url = this.ep.deleteItem + '/' + id;
...
ApiService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_endpoints__WEBPACK_IMPORTED_MODULE_3__["EndPoint"], _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]])
], ApiService);
