...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ItemFormModule", function() { return ItemFormModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ "ofXK");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _endpoints__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../endpoints */ "Mumn");
/* harmony import */ var _shared_services_api_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../shared/services/api.service */ "nm5K");
/* harmony import */ var _shared__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../shared */ "M0ag");
/* harmony import */ var _itemform_routing_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./itemform-routing.module */ "ndDi");
/* harmony import */ var _itemform_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./itemform.component */ "LyKH");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @angular/forms */ "3Pt+");
/* harmony import */ var _shared_directives_decimal_only_directive__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../shared/directives/decimal-only-directive */ "cgC3");
...
let ItemFormModule = class ItemFormModule {
};
ItemFormModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_itemForm_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./itemForm.component.html */ "prCO");
/* harmony import */ var _itemForm_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./itemForm.component.scss */ "0Wvb");
...
let ItemFormComponent = class ItemFormComponent {
    constructor(apiService, formBuilder, route, toastr) {
    ...
    ngOnInit() {
        this.route.params.subscribe((params) => {
            ...
            this.submitBtnName = flag === 'D' ? 'Delete Item' : flag === 'M' ? 'Update Item' : 'Save Item';
            this.formTitle = flag === 'D' ? 'Delete Item' : flag === 'M' ? 'Update Item' : 'Add Item';
            this.formIcon = flag === 'D' ? 'fa-trash' : flag === 'M' ? 'fa-edit' : 'fa-plus';
            this.selectedItem.op_flag = flag;
            console.log('idid::', id);
            if (id !== '0') {
                const itmResp = null;
                this.apiService.getItemById(id).subscribe((data) => {
                    ...
                    if (data) {
                        ...
                        this.selectedItem.itemName = data.itemName;
                        this.selectedItem.itemDescription = data.itemDescription;
                        this.selectedItem.itemPrice = data.itemPrice;
                        this.selectedItem.itemImageUri = data.itemImageUri;
                        this.imageUri = data.itemImageUri;
                    }
                    else {
                        this.selectedItem.id = 0;
                        this.selectedItem.itemName = null;
                        this.selectedItem.itemDescription = null;
                        this.selectedItem.itemPrice = null;
                        this.selectedItem.itemImageUri = null;
                        this.imageUri = '../../../assets/images/album_cover.png';
                    }
                });
    ...
    onFileChange(event) {
        ...
        if (event.target.files && event.target.files[0]) {
            ...
            reader.onload = (ev) => {
                this.selectedItem.itemImageUri = ev.target.result;
                console.log('imageUri::', this.imageUri);
                this.imageUri = ev.target.result;
            };
    ...
    saveDeleteItem() {
        if (this.selectedItem.op_flag === 'D') {
            this.apiService.deleteItem(this.selectedItem.id).subscribe((res) => {
                console.log('res', res);
                if (JSON.parse(JSON.stringify(res))) {
                    this.toastr.success('Success', 'Item Deleted Successfully !', {
                        closeButton: true,
                    ...
                    this.toastr.error('Failed', 'Unable to deleted item !', {
                        closeButton: true,
                        positionClass: 'toast-bottom-right'
                    });
                }
            ...
            this.apiService.saveItem(this.selectedItem).subscribe((res) => {
                if (JSON.parse(JSON.stringify(res)).status === 'success') {
                    this.toastr.success('Success', 'Item Save Successfully !', {
                        closeButton: true,
                        positionClass: 'toast-bottom-right'
                    });
                    this.resetForm();
                    ...
                    this.toastr.error('Failed', 'Unable to save item !', {
                        closeButton: true,
                        positionClass: 'toast-bottom-right'
                    });
                }
            ...
            this.apiService.updateItem(this.selectedItem).subscribe((res) => {
                if (JSON.parse(JSON.stringify(res)).status === 'success') {
                    ...
                    this.toastr.error('Failed', 'Unable to update item !', {
                        closeButton: true,
                        positionClass: 'toast-bottom-right'
                    });
                }
    ...
    resetForm() {
        ...
        this.imageUri = '../../../assets/images/album_cover.png';
        this.submitBtnName =
            this.selectedItem.op_flag === 'D'
                ? 'Delete Item'
                : this.selectedItem.op_flag === 'M'
                    ? 'Update Item'
                    : 'Save Item';
        this.formTitle =
            this.selectedItem.op_flag === 'D'
                ...
                : this.selectedItem.op_flag === 'M'
                    ...
                    : 'Add Item';
        this.formIcon =
            this.selectedItem.op_flag === 'D' ? 'fa-trash' : this.selectedItem.op_flag === 'M' ? 'fa-edit' : 'fa-plus';
...
ItemFormComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_shared_services_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DecimalOnlyDirective", function() { return DecimalOnlyDirective; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
...
let DecimalOnlyDirective = class DecimalOnlyDirective {
...
DecimalOnlyDirective.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["NgControl"] }
];
DecimalOnlyDirective.propDecorators = {
    onInput: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["HostListener"], args: ['input', ['$event.target.value'],] }],
    onBlur: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["HostListener"], args: ['blur', ['$event.target.value'],] }]
};
DecimalOnlyDirective = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Directive"])({
        // tslint:disable-next-line:directive-selector
        selector: '[OnlyDecimal]'
    }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["NgControl"]])
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ItemFormRoutingModule", function() { return ItemFormRoutingModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "tyNb");
/* harmony import */ var _itemform_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./itemform.component */ "LyKH");
...
let ItemFormRoutingModule = class ItemFormRoutingModule {
};
ItemFormRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
//# sourceMappingURL=item-form-itemform-module-es2015.js.map