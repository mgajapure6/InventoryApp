...
/* harmony import */ var _raw_loader_inventory_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./inventory.component.html */ "OXO9");
/* harmony import */ var _inventory_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./inventory.component.scss */ "ZJMm");
...
let InventoryComponent = class InventoryComponent {
    constructor(apiService, pipe) {
        this.apiService = apiService;
        this.pipe = pipe;
        this.itemsList = new Array(); // Observable<Item[]>;
        this.filter = new _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormControl"]('');
        this.apiService.itemList().subscribe((data) => {
            this.itemsList = data;
        });
        this.filter.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["map"])((text) => search(this.itemsList, text, pipe)));
    }
    ngOnInit() { }
};
...
InventoryComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_shared_services_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"], _angular_common__WEBPACK_IMPORTED_MODULE_7__["DecimalPipe"]])
], InventoryComponent);
...
/* harmony import */ var _inventory_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./inventory.component */ "N1Bz");
...
/* harmony import */ var _endpoints__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../endpoints */ "Mumn");
/* harmony import */ var _shared_services_api_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../shared/services/api.service */ "nm5K");
/* harmony import */ var _shared__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../shared */ "M0ag");
/* harmony import */ var _inventory_routing_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./inventory-routing.module */ "X1qe");
/* harmony import */ var _inventory_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./inventory.component */ "N1Bz");
